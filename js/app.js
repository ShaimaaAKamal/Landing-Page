...
function myActiveScroll() {
    ...
    for (sec of sections) {
        ...
        if (document.documentElement.scrollTop > scrolPos) {
            if (height < winHeight) {
                if (bottomPosition <= winHeight && rightPosition <= winWidth) {
                    if ((topPosition > (-0.95 * height) && topPosition < 0.95 * winHeight) && (leftPosition > (-0.95 * width) && (leftPosition < 0.95 * width))) {
                        innerFun(sec);
                        break;
                    }
                } else if (sec.id = "section1") {
                    if ((topPosition >= 0 && topPosition <= 0.95 * winHeight) && (leftPosition >= 0 && (leftPosition <= 0.95 * width))) {
                        innerFun(sec);
                        break;
                    }
                }
            ...
            if (height < winHeight) {
                if (topPosition > 0 && topPosition < 0.85 * winHeight && leftPosition > 0  && leftPosition<0.85*Width) {
                    innerFun(sec);
                    break;
                }
            } else {
                if (topPosition >= 0 && topPosition <= winHeight && leftPosition >= 0&& leftPosition <= winWidth) {
                    innerFun(sec);
                    break;
                }
    ...
    scrolPos = document.documentElement.scrollTop;
